        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <section className="rounded-[2rem] border border-white/70 bg-[linear-gradient(180deg,rgba(15,23,42,0.97),rgba(15,118,110,0.92))] p-8 text-white shadow-[0_30px_90px_-45px_rgba(15,23,42,0.8)]">
            ...
            <h1 className="mt-4 text-4xl font-semibold tracking-tight">
              Start a real conversation about turning RouteAlpha into a production-grade AI routing platform.
            </h1>
            ...
            <div className="mt-8 grid gap-4">
              <ContactHighlight
                ...
                detail="Capture what you are building, how big the team is, and what decisions RouteAlpha should improve."
              />
              <ContactHighlight
          ...
          <section className="rounded-[2rem] border border-white/70 bg-white/88 p-8 shadow-[0_24px_80px_-42px_rgba(15,23,42,0.32)] backdrop-blur-sm">
            <div>
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                We can use this intake to shape roadmap priorities and the next platform features.
              </p>
            </div>
